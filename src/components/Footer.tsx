        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {categories.map((cat) => (
                <li key={cat.slug}>
                  <Link href={`/category/${cat.slug}`} className="text-sm text-gray-400 hover:text-white transition-colors">{cat.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-sm font-semibold text-white mb-3 uppercase tracking-wider">Policies</h4>
            <ul className="space-y-2">
