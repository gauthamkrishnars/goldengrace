    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <nav className="text-xs text-gray-400 mb-6">
          <Link href="/" className="hover:text-brand">Home</Link> / <span className="text-gray-700">Returns & Exchange</span>
        </nav>
        <h1 className="font-serif text-3xl font-bold text-gray-800 mb-6">Returns & Exchange Policy</h1>
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-gray-600 leading-relaxed">
          ...
          <h2 className="font-serif text-xl font-bold text-gray-800">Lifetime Exchange</h2>
          <p>All BIS hallmarked gold jewellery comes with a lifetime exchange guarantee. You can exchange your jewellery at any time for full value towards a new purchase. Making charges are deducted as per policy.</p>
