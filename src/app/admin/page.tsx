...
import {
  ...
  Eye, ChevronDown, Image as ImageIcon, CheckCircle, AlertCircle
} from "lucide-react";
import { products as mockProducts, categories, formatPrice } from "@/data/products";
...
export default function AdminPage() {
  ...
  const handleSaveProduct = (e: React.FormEvent) => {
    ...
    const productData: Product = {
      id: editingProduct?.id || `admin-${Date.now()}`,
      name: form.name,
      ...
      stoneWeight: form.stoneWeight || undefined,
  ...
  const totalRevenue = productList.reduce((sum, p) => sum + p.price, 0);
  const avgPrice = productList.length > 0 ? totalRevenue / productList.length : 0;
          ...
          <div className="md:col-span-3">
            ...
            {activeTab === "dashboard" && (
              <div className="space-y-6">
                ...
                {/* Recent Products */}
                <div className="bg-white rounded-2xl border border-gray-100 p-6">
                  <h3 className="text-sm font-semibold text-gray-800 mb-4">Recent Products</h3>
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  {product.discount && (
                                    <span className="text-[10px] bg-red-50 text-red-500 px-1.5 py-0.5 rounded">{product.discount}% OFF</span>
                                  )}
                                </div>
                              </div>
                            </td>
              ...
              <div>
                ...
                <form onSubmit={handleSaveProduct} className="space-y-6">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 p-6">
                    ...
                    {uploadStatus === "success" && (
                      <p className="text-xs text-green-600 mt-2 flex items-center gap-1">
                        <CheckCircle className="h-3 w-3" /> Images added successfully
                      </p>
                    )}

                    <p className="text-xs text-gray-400 mt-2">
                      Upload product images from your computer. Images are stored locally. Connect Supabase for cloud storage.
                    </p>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="e.g., 18K White Gold | 1 Ct Diamond"
                          className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20"
                        />
                      </div>
                      <div className="md:col-span-2">
                        ...
                        <textarea
                          ...
                          rows={4}
                          className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20 resize-none"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20"
                        >
                          {["18K White Gold", "14K White Gold", "14K Rose Gold", "14K Yellow Gold", "22K Yellow Gold", "Platinum"].map((m) => (
                      ...
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="diamond, solitaire, engagement"
                          className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20"
                        />
                      </div>
                    </div>
                  ...
                  <div className="flex gap-3">
                    <button
                      type="submit"
                      className="flex items-center gap-2 px-6 py-3 bg-brand text-white text-sm font-semibold rounded-xl hover:bg-brand/90 transition-colors"
                    >
